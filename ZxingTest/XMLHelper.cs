...
namespace ZxingTest
{
    public  class XMLHelper
    {
        ...
        private XmlDocument pDoc=new XmlDocument();
        ...
        /// <returns></returns>
        public string QueryNodeText(string nodeName)
        {
            string xmlString = "";
            try
            {

                var documentElementRoot = pDoc.DocumentElement;
        ...
        /// <returns></returns>
        public bool ModifyNode(string nodeName, string nodeValue)
        {
            try
            {
                var documentElement = pDoc.DocumentElement;
